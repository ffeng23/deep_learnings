...
#### Why cross entropy loss vs mse loss

+ it makes bigger the gradient for confident wrong predictions and therefore fast learning

+ it makes the loss curve/surface smoother and less likely to be stuck on local minimum.
...
Other excellent explanation about back propogation algorithm.
