...
pdf version in the repo is here at "./A Gentle Introduction to Graph Neural Networks.pdf".
...
## GNN w/o message passing

Simple GNN could have no communications between different components of the network and each nodes are taken care of by separate MLPs.

MPNN are the ones with communications among different components.
